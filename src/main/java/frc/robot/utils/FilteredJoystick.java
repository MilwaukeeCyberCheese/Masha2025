...
public class FilteredJoystick {
  ...
  /** Returns the x-value of the joystick */
  public double getX() {
    return this.getX(Constants.IOConstants.DRIVE_DEADBAND);
  }
   ...
   */
  public double getY() {
    return this.getY(Constants.IOConstants.DRIVE_DEADBAND);
  }
   ...
   */
  public double getZ() {
    return this.getZ(Constants.IOConstants.DRIVE_DEADBAND);
  }
  ...
  public double getThrottle() {
    return this.getThrottle(Constants.IOConstants.DRIVE_DEADBAND);
  }
