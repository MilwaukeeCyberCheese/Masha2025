...
public final class AprilTags {
    ...
    public static List<Integer> reefTags() {
        return DriverStation.getAlliance().orElse(null) == DriverStation.Alliance.Blue ? BLUE_REEF_TAGS : RED_REEF_TAGS;
    }

    public static final Transform2d REEF_ALIGN_OFFSET = new Transform2d(0.6, 0, Rotation2d.kPi);

    public static int findTagForAlignment(Pose2d robotPose) {
        var currentTag = -1;
