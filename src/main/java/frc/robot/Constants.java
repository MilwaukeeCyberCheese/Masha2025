...
public final class Constants {
  ...
  public static class Sensors {
    ...
    public static final Rev2mDistanceSensor HANDLER_DISTANCE_SENSOR =
        new Rev2mDistanceSensor(Rev2mDistanceSensor.Port.kOnboard);

    static {
      HANDLER_DISTANCE_SENSOR.setDistanceUnits(Rev2mDistanceSensor.Unit.kInches);
    }
  }
  ...
  public static class Elevator {
    ...
    public static final SparkMax LEFT_ELEVATOR_SPARK_MAX =
    ...
    public static final SparkLimitSwitch ELEVATOR_LIMIT_SWITCH =
        LEFT_ELEVATOR_SPARK_MAX.getReverseLimitSwitch();
    ...
    public static final SparkClosedLoopController ELEVATOR_CONTROLLER =
        LEFT_ELEVATOR_SPARK_MAX.getClosedLoopController();
    ...
    static {
      ...
      RIGHT_ELEVATOR_CONFIG.follow(
              LEFT_ELEVATOR_SPARK_MAX); // you can pass in an inverted value after the
      // kLeftElevatorSparkMax, but idk quite how that works yet

      LEFT_ELEVATOR_CONFIG
          .closedLoop
          .feedbackSensor(FeedbackSensor.kPrimaryEncoder)
          .pid(ELEVATOR_P_I_D_CONSTANTS.p, ELEVATOR_P_I_D_CONSTANTS.i, ELEVATOR_P_I_D_CONSTANTS.d)
          .maxMotion
          .maxAcceleration(ELEVATOR_P_I_D_CONSTANTS.maxAcceleration)
          .maxVelocity(ELEVATOR_P_I_D_CONSTANTS.maxVelocity);

      LEFT_ELEVATOR_CONFIG.encoder.positionConversionFactor(CONVERSION_FACTOR);
    ...
    public static class Coral {
      ...
      static {
        ...
        LEFT_CONFIG
            .closedLoop
            .feedbackSensor(FeedbackSensor.kPrimaryEncoder)
            .pid(P_I_D_CONSTANTS.p, P_I_D_CONSTANTS.i, P_I_D_CONSTANTS.d)
            .outputRange(-1, 1)
            .maxMotion
            .maxAcceleration(P_I_D_CONSTANTS.maxAcceleration);
    ...
    public static class Algae {
      ...
      static {
        ...
        POSITION_CONFIG
            ...
            .pid(POSITION_P_I_D_CONSTANTS.p, POSITION_P_I_D_CONSTANTS.i, POSITION_P_I_D_CONSTANTS.d)
            .outputRange(-1, 1);

        INTAKE_CONFIG
            .closedLoop
            .feedbackSensor(FeedbackSensor.kPrimaryEncoder)
            .pid(INTAKE_P_I_D_CONSTANTS.p, INTAKE_P_I_D_CONSTANTS.i, INTAKE_P_I_D_CONSTANTS.d)
            .outputRange(-1, 1);
      }
    }
  }
  ...
  public static class Climber {
    ...
    static {
      ...
      CLIMBER_CONFIG
          .closedLoop
          .feedbackSensor(FeedbackSensor.kAbsoluteEncoder)
          .pid(CLIMBER_P_I_D_CONSTANTS.p, CLIMBER_P_I_D_CONSTANTS.i, CLIMBER_P_I_D_CONSTANTS.d)
          .outputRange(-1, 1);
    }
  }
